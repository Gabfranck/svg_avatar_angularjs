    ...
    angular.module(moduleName, [])
        .factory('svgAvatarService', function(){
            ...
            return {
                ...
                modify_avatar: function(avatar,part,change,direction){
                  return svgAvatar.modify_avatar(avatar,part,color,direction)
                },
                modify_avatar_svg: function(avatar,part,color,direction){
                  return svgAvatar.modify_avatar_svg(avatar,part,color,direction)
                },
                render_random_svg: function(){
                    return svgAvatar.render_random_svg()
                },
                next_pattern_avatar: function(avatar, part){
                    return svgAvatar.next_pattern_avatar(avatar, part)
                },
                next_pattern_svg: function(avatar, part){
                    return svgAvatar.next_pattern_svg(avatar, part)
                },
                previous_pattern_avatar: function(avatar, part){
                    return svgAvatar.previous_pattern_avatar(avatar, part)
                },
                previous_color_svg: function(avatar, part){
                    return svgAvatar.previous_color_svg(avatar, part)
                },
                next_color_avatar: function(avatar, part){
                    return svgAvatar.next_color_avatar(avatar, part)
                },
                next_color_svg: function(avatar, part){
                    return svgAvatar.next_color_svg(avatar, part)
                },
                previous_color_avatar: function(avatar, part){
                    return svgAvatar.previous_color_avatar(avatar, part)
                },
                previous_color_svg: function(avatar, part){
                    return svgAvatar.previous_color_svg(avatar, part)
                }
        ...
        .directive('svgAvatar', function($sce){
            return {
                ...
                template: '<div style="display: inline-block; margin-top: 5px; vertical-align: middle;"><svg id="{{avatarId}}" width="{{avatarWidth}}" height="{{avatarHeight}}" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" ng-bind-html="renderHtml(avatar)"></svg></div>',
